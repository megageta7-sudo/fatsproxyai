...
const API_REWRITES = {
  ...
  "/api/admin/health": "./api/admin.js",
  "/api/admin/keys": "./api/admin.js",
  "/api/admin/config": "./api/admin.js",
  "/api/admin/auth": "./api/admin.js",
  "/api/admin/test-keys": "./api/admin.js",
  "/api/admin/extension-key": "./api/admin.js",
  "/api/admin/stats": "./api/admin.js",
